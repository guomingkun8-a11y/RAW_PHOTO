...
SECRET_MAPPINGS: tuple[tuple[tuple[str, ...], str], ...] = (
    ...
    (("ai_review", "api_key"), "CHATGPT2API_AI_REVIEW_API_KEY"),
    (("backup", "access_key_id"), "CHATGPT2API_BACKUP_ACCESS_KEY_ID"),
    (("backup", "secret_access_key"), "CHATGPT2API_BACKUP_SECRET_ACCESS_KEY"),
    (("backup", "passphrase"), "CHATGPT2API_BACKUP_PASSPHRASE"),
    (("image_reference_upload", "qiniu_access_key"), "CHATGPT2API_QINIU_ACCESS_KEY"),
    (("image_reference_upload", "qiniu_secret_key"), "CHATGPT2API_QINIU_SECRET_KEY"),
    (("image_storage", "webdav_password"), "CHATGPT2API_WEBDAV_PASSWORD"),
    (("image_storage", "minio_access_key"), "CHATGPT2API_MINIO_ACCESS_KEY"),
    (("image_storage", "minio_secret_key"), "CHATGPT2API_MINIO_SECRET_KEY"),
    (("openai_relay", "api_key"), "CHATGPT2API_OPENAI_RELAY_API_KEY"),
    (("openai_relay", "api_keys"), "CHATGPT2API_OPENAI_RELAY_API_KEYS"),
    (("proxy_runtime", "clearance", "cf_cookies"), "CHATGPT2API_CF_COOKIES"),
    (("proxy_runtime", "clearance", "cf_clearance"), "CHATGPT2API_CF_CLEARANCE"),
)

URL_MAPPINGS: tuple[tuple[tuple[str, ...], str, object], ...] = (
    (("proxy",), "CHATGPT2API_PROXY_URL", ""),
    (("proxy_runtime", "proxy_url"), "CHATGPT2API_PROXY_URL", ""),
    (("proxy_runtime", "resource_proxy_url"), "CHATGPT2API_RESOURCE_PROXY_URL", ""),
    (("image_storage", "webdav_url"), "CHATGPT2API_WEBDAV_URL", ""),
    (("image_task_queue", "redis_url"), "IMAGE_TASK_REDIS_URL", "redis://127.0.0.1:6379/0"),
    (("image_task_queue", "database_url"), "IMAGE_TASK_DATABASE_URL", ""),
)
